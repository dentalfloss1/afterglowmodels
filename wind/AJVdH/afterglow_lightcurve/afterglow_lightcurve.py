...
print(np.sum(nuc_arr < num_arr),1)
print(np.sum(nua2_arr < nuc_arr),2)
print("spectrum 5^")
print(np.sum(num_arr < nuc_arr),3)
print(np.sum(nua1_arr < num_arr),4)
print("spectrum 1^")
print(np.sum(nua3_arr < nuc_arr),5)
print(np.sum(num_arr < nua3_arr),6)
print("spectrum 2^")
input("presskey")
